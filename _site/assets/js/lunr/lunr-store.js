var store = [{
        "title": "'알라미' 사례 연구 분석",
        "excerpt":"'알라미'는 어떻게 1억 유저를 달성했나 이 콘텐츠는 ‘조코딩’ 채널의 팟캐스트 인터뷰 영상을 기반으로 합니다. 1인 개발로 시작해 연 매출 337억을 달성한 ‘알라미’ 신재명 대표의 여정을 4가지 핵심 전략으로 분석했습니다. 아티클 슬라이드 오디오 퀴즈 1인 개발 알람 앱, 연 매출 337억을 달성한 4가지 역발상 전략 알람 앱 ‘알라미(Alarmy)’는 1인 개발로 시작해...","categories": ["insights"],
        "tags": [],
        ...
        "excerpt":"AI 코딩, 빠르게만 하려고 하셨나요? '느리게' 일하며 효율을 높이는 방법 이 글은 AI 코딩의 ‘혼돈’ 속에서 제가 겪은 시행착오와, 그 끝에 정착한 저만의 워크플로우 ‘Slow Vibe Coding’에 대한 기록입니다. 무조건적인 속도 대신, 1인 개발자가 지치지 않고 AI와 오랫동안 협력할 수 있는 현실적인 방법을 공유합니다. 도입: AI 코딩의 혼돈 속에서 나만의...","categories": ["coding"],
        "tags": [],
