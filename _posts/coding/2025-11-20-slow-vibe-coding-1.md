...
* [도입: AI 코딩의 혼돈 속에서 나만의 길 찾기](#introduction)
* [핵심 원칙 1: AI 에이전트가 아닌 '가상 팀'을 만듭니다](#principle-1)
* [핵심 원칙 2: 코드보다 '논의'에 집중합니다](#principle-2)
* [핵심 원칙 3: 무조건적인 자동화를 거부합니다](#principle-3)
* [핵심 원칙 4: 가장 비싼 모델 대신 '충분히 좋은' 모델을 선택합니다](#principle-4)
* [그래도 개발자의 새로운 역할은?](#role)
* [결론: 속도보다 중요한 것](#conclusion)
